...
const translations: Record<'ar' | 'en', Record<string, string>> = {
  ar: {
    ...
    'services.brandingDesc': 'نحن نصمم هويات تجارية فريدة تتردد صداها مع جمهورك المستهدف. من تصميم الشعار إلى دليل الهوية الكامل، نضمن تميز عملك في سوق مزدحم.',
    'services.catalogs': 'الكتالوجات وبروفايلات الشركات',
    'services.catalogsDesc': 'تصميم كتالوج وبروفايل شركة احترافي يحكي قصتك بشكل فعال. نحن نجمع بين التخطيطات عالية الجودة والسرد البصري المقنع.',
    'services.animation': 'الرسوم المتحركة والموشن جرافيك',
    'services.animationDesc': 'إحياء الأفكار من خلال الحركة. خدمات الموشن جرافيك والرسوم المتحركة لدينا تحول المفاهيم المعقدة إلى تجارب بصرية جذابة.',
  ...
  en: {
    ...
    'services.brandingDesc': 'We craft unique brand identities that resonate with your target audience. From logo design to complete brand guidelines, we ensure your business stands out in a crowded market.',
    'services.catalogs': 'Catalogs & Profiles',
    'services.catalogsDesc': 'Professional catalog and company profile design that tells your story effectively. We combine high-quality layouts with compelling visual storytelling.',
    'services.animation': 'Animation & Motion Graphics',
    'services.animationDesc': 'Bringing ideas to life through movement. Our motion graphics and animation services transform complex concepts into engaging visual experiences.',
